...
//
// Solidity: function initialize(uint256 _unlockPeriod, uint256 _minStakeAmount, address initialOwner) returns()
func (_StakeContract *StakeContractTransactor) Initialize(opts *bind.TransactOpts, _unlockPeriod *big.Int, _minStakeAmount *big.Int, initialOwner common.Address) (*types.Transaction, error) {
	return _StakeContract.contract.Transact(opts, "initialize", _unlockPeriod, _minStakeAmount, initialOwner)
}

// Initialize is a paid mutator transaction binding the contract method 0xa6ab36f2.
//
// Solidity: function initialize(uint256 _unlockPeriod, uint256 _minStakeAmount, address initialOwner) returns()
func (_StakeContract *StakeContractSession) Initialize(_unlockPeriod *big.Int, _minStakeAmount *big.Int, initialOwner common.Address) (*types.Transaction, error) {
	return _StakeContract.Contract.Initialize(&_StakeContract.TransactOpts, _unlockPeriod, _minStakeAmount, initialOwner)
}

// Initialize is a paid mutator transaction binding the contract method 0xa6ab36f2.
//
// Solidity: function initialize(uint256 _unlockPeriod, uint256 _minStakeAmount, address initialOwner) returns()
func (_StakeContract *StakeContractTransactorSession) Initialize(_unlockPeriod *big.Int, _minStakeAmount *big.Int, initialOwner common.Address) (*types.Transaction, error) {
	return _StakeContract.Contract.Initialize(&_StakeContract.TransactOpts, _unlockPeriod, _minStakeAmount, initialOwner)
}
