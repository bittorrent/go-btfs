...
//	//Getter
//	//Putter
//	//GetMulti(ctx context.Context, mode ModeGet, addrs ...string) (ch []swarm.Chunk, err error)
//	Hasser
//	Setter
...
//	Get(ctx context.Context, mode ModeGet, addr string) (ch swarm.Chunk, err error)
//}

//type Setter interface {
//	Set(ctx context.Context, mode ModeSet, addrs ...string) (err error)
//}
//
//type Hasser interface {
//	Has(ctx context.Context, addr string) (yes bool, err error)
//	HasMulti(ctx context.Context, addrs ...string) (yes []bool, err error)
//}
//
