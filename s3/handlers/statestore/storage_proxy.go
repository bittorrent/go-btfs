...
var _ handlers.StateStorer = (*StorageProxy)(nil)
...
func (s *StorageProxy) Get(key string, i interface{}) (err error) {
	...
	if errors.Is(err, storage.ErrNotFound) {
		err = handlers.ErrStateStoreNotFound
	}
	return
}
...
func (s *StorageProxy) Iterate(prefix string, iterFunc handlers.StateStoreIterFunc) (err error) {
