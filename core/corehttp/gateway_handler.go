...
// 			webError(w, err, http.StatusNotFound)
// 			return
// 		}
...
// 	if !ok {
// 		webError(w, dag.ErrNotProtobuf, http.StatusBadRequest)
// 		return
// 	}
...
// 			webError(w, coreiface.ErrOffline, http.StatusServiceUnavailable)
...
// 	if prfx := r.Header.Get("X-Btfs-Gateway-Prefix"); prfx != "" {
