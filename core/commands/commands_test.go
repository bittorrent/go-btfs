...
func TestCommands(t *testing.T) {
	list := []string{
		...
		"/storage/upload/proxy/pay",
		"/storage/upload/proxy/list",
		...
		"/storage/upload/renew/service/stop",
		"/storage/upload/renew/service/restart",
		"/storage/upload/renew/service/status",
		"/test",
		"/test/cheque",
		"/test/hosts",
		"/test/p2phandshake",
